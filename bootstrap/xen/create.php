<div class="col-md-12">
        <div class="panel panel-default">
                <div class="panel-heading">Create Xen Virtual Machine</div>
                <div class="panel-body">
                        <?php echo form_open('libxen/create', array('class' => 'form-horizontal')); ?>
                        ...
                        <div class="form-group<?php echo (my_form_error('name') != FALSE ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                        <?php
                                                ...
                                                echo form_dropdown('user', $options, set_value('user'), 'class="selectpicker" data-live-search="true"');
                                        ?>
                        ...
                        <div class="form-group<?php echo (my_form_error('location') != FALSE ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                        <?php
                                                ...
                                                echo form_dropdown('location', $location_options, set_value('location'), 'class="selectpicker"');
                                        ?>
                        ...
                        <div class="form-group<?php echo (my_form_error('node') != FALSE ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-8">
                                        <?php echo form_dropdown('node', $nodes, set_value('node'), 'class="selectpicker" data-live-search="true"'); ?>
