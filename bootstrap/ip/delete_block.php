        ...
        <div class="modal-dialog">
                <div class="modal-content">
                        <div class="modal-header">
                                ...
                                <h4 class="modal-title">Delete IPv4 Block <?php echo $block->block_name; ?></h4>
                        </div>
                        ...
                        <div class="modal-footer">
                                <?php echo form_open('ip/delete_block/'.$block->block_id); ?>
...
<?php else: ?>
        ...
        <div class="col-md-12">
                <div class="panel panel-default">
                        <div class="panel-heading">Delete IPv4 Block <?php echo $block->block_name; ?></div>
